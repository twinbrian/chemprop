...
def data(mixed_regression_data):
    ...
    all_data = []
    all_data.append(
        [MolDatapoint.from_smi(smi, y, keep_h=True) for smi, y in zip(smis, mol_Y)]
    )
    ...
    for i in range(len(smis)):
        ...
        atom_datapoints.append(MolDatapoint.from_smi(smi, y, keep_h=True))
    ...
    for i in range(len(smis)):
        ...
        bond_datapoints.append(MolDatapoint.from_smi(smi, y, keep_h=True))
